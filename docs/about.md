...
<small>※ 本音を言ってしまうと、僕とコントリビューターの方々の分だけでも上手くマネタイズする方法は探りたいです。この開発にもそれなりに時間が掛かってしまっているのと、クライアントワークは体質的にもあまり向いていないので…。試験的に[GitHub Sponsors](https://github.com/sponsors/baku89?o=sd&sc=t)を試していますので、よろしければご支援お願いします。</small>
