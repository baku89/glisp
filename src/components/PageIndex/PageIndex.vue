...
export default defineComponent({
	...
	setup(_, context) {
		...
		AppScope.readEval(`(do
			...
			(register-keybind "shift+up" '(transform-selected (translate [0 -10])))
			(register-keybind "shift+down" '(transform-selected (translate [0 10])))
			(register-keybind "shift+right" '(transform-selected (translate [10 0])))
			(register-keybind "shift+left" '(transform-selected (translate [-10 0])))
			(register-keybind "alt+up" '(transform-selected (translate [0 -0.1])))
			(register-keybind "alt+down" '(transform-selected (translate [0 0.1])))
			(register-keybind "alt+right" '(transform-selected (translate [0.1 0])))
			(register-keybind "alt+left" '(transform-selected (translate [-0.1 0])))
